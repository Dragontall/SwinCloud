...
class SwinTransformerBlock(nn.Module):
    ...
    def __init__(self, dim, input_resolution, num_heads, window_size=7, shift_size=0,
        ...
        self.local_proj = SeparableConvBN(dim, dim, kernel_size=window_size)
...
class FeatureRefinementHead(nn.Module):
    def __init__(self, input_resolution=(56,56), in_channels=96, decode_channels=96):
        super().__init__()
...
class SwinTransformerSys(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=4, in_chans=3, num_classes=1000,
        ...
        self.frh = FeatureRefinementHead(input_resolution=(56,56), in_channels=96, decode_channels=96)
...
class SwinCloud(nn.Module):
    def __init__(self, img_size=224, num_classes=2, zero_head=False, vis=False):
        ...
        self.swin_cloud = SwinTransformerSys(img_size=224,
                                patch_size=4,
                                in_chans=3,
